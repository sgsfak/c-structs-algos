 ...
 */
extern uint32_t djb33_hash(const char* s, size_t len);
 ...
 */
extern uint32_t h31_hash(const char* s, size_t len);
 ...
 */
extern uint32_t fnv32_hash(const char *str, size_t len);
 ...
 */
extern uint32_t ejb_hash(const char *s, size_t len);


/*
 * Bob Jenkins "One-at-a-time" hash
 */
extern uint32_t oat_hash(const char *s, size_t len);


extern uint32_t jen_hash(const char *k, size_t length);
extern uint32_t elf_hash(const char *key, size_t len);
