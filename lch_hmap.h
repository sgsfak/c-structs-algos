 ...
 */
extern lch_hmap_t* ht_create(uint32_t initial_size, 
        uint32_t (*hfn_t)(const char*, size_t));

/*
 * Returns the current "load factor" of the hashmap
 */
extern float ht_load_factor(lch_hmap_t* h);
extern lch_hmap_stats_t ht_stats(lch_hmap_t* h);


extern void ht_delete(lch_hmap_t* ht, const char* word);

/*
 * Finds the entry with the given key.
 * Returns NULL if not found
 */
extern lch_value_t* ht_get(lch_hmap_t* ht, const char* word);
 ...
 */
extern lch_value_t* ht_put(lch_hmap_t* ht, const char* word);

/*
 * Checks is the given key exists in the hashmap
 */
extern bool ht_exists(lch_hmap_t* ht, const char* word);

extern void ht_traverse(lch_hmap_t* ht, 
 ...
 */
extern void ht_destroy(lch_hmap_t* ht, 
